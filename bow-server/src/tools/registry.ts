...
import { Logger, Tool, ToolResult, PermissionLevel, PERMISSION_LEVELS, SAFE_TOOLS, CONFIRM_TOOLS, BLOCKED_TOOLS, getCurrentTimestamp } from "@bow/shared";
...
export class ToolRegistry {
    ...
    private registerDefaultTools(): void {
        ...
        this.register({
            ...
            handler: async () => ({ success: true } as ToolResult),
            schema: {
                type: "object",
                properties: {
    ...
    validateInput(toolName: string, input: unknown): { valid: boolean; errors: string[] } {
    ...
    private validateSchema(schema: ToolSchema, value: unknown, path: string = ""): string[] {
        const errors: string[] = [];
